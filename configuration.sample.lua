local CONFIGURATION = {
    ...
    provider_settings = {
        ...
        openrouter = {
            ...
            -- (e.g. groq_wait_seconds for the Groq rate-limit debounce).
            model_parameters = {
        ...
        groq = {
            ...
            additional_parameters = {
                ...
                -- 
                -- groq free API limit waits; omitted (e.g. in a per-model
                -- preset) falls back to the handler's built-in default (15 s).
                -- Explicit values are respected: set 0 to disable the debounce
                -- entirely (e.g. on paid tiers).
